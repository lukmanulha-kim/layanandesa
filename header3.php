...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i>  <span class="text">Welcome <?php echo $_SESSION['Nama']; ?> </span></a>
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    <li><a href="BerandaKades"><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>
    ...
    <li> <a href="?page=pelayanan"><i class="icon icon-pencil"></i> <span>Pelayanan</span></a> </li>
