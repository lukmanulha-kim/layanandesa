...
Inner Join tb_jenissurat ON tb_jenissurat.id_jenis = tb_layanan.id_jenissurat where month(tgl_pelayanan)='$Bulan' and year(tgl_pelayanan)='$Tahun' and tb_layanan.id_jenissurat=$Jeniss");
