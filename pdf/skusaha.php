...
$pdf->SetX(1);
$pdf->SetFont('Times','',12);
$pdf->Cell(19,0.6,'Yang bertanda tangan dibawah ini :',0,1,'L');
...
$pdf->Cell(1,0.6,':',0,0,'C');
$pdf->Cell(13,0.6,$Tpt_Lahir.', '.$Tgl_Lahir,0,1,'L');
...
$pdf->Cell(5,0.6,'NIK',0,0,'L');
$pdf->Cell(1,0.6,':',0,0,'C');
$pdf->Cell(13,0.6,$NIK,0,1,'L');
$pdf->Cell(5,0.6,'Alamat',0,0,'L');
$pdf->Cell(1,0.6,':',0,0,'C');
$pdf->MultiCell(13,0.6,'Desa '.$Alamat.' RT.'.$RT.' RW.'.$RW.' Kecamatan Sukosari Kabupaten Bondowoso',0,'L');

$pdf->SetY(16);
$pdf->SetX(1);
$pdf->SetFont('Times','',12);
$pdf->Cell(19,0.6,'Keterangan lain : ',0,1,'J');
...
$pdf->Cell(7,0.6,'Bondowoso, '. $Tgl_Proses,0,1,'C');
$pdf->Cell(12,0.6,' ',0,0,'L');
