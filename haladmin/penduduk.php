      ...
      <div class="widget-content">
        <form action="" method="post" name="forminput" class="form-horizontal">
          ...
          <div class="control-group" id="div">
            ...
            <div class="controls">
              <input type="number" id="i_nik" name="i_nik" class="span8" value="351104" onkeyup="HitungNIK()" required>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="number" name="i_nokk" class="span8" value="351104" onkeyup="HitungNOKK()" required>
        ...
        if (isset($_POST['simpan'])) {
          ...
          if ($Status=="Kepala Keluarga") {
            $Stutas = "Kepala Keluarga";
          }

          $cek = mysqli_query($dbconnect, "SELECT nik FROM tb_penduduk where nik='$NIK'");

          $cek2 = mysqli_query($dbconnect, "SELECT no_kk, stat_hub_kel FROM tb_penduduk where no_kk='$NOKK' and stat_hub_kel='$Stutas'");
          ...
          if ($JumlahNIK<16 || $JumlahNIK>16 || $JumlahKK<16 || $JumlahKK>16) {
            ...
            echo "<script type='text/javascript'>alert('Data Tersebut Sudah Menjadi Kepala Keluarga Dalam Satu KK !.')</script>";
            echo "<script type='text/javascript'>history.go(-1)</script>";
          }elseif($JK=="Laki-Laki" && $Status=="Istri"){
            echo "<script type='text/javascript'>alert('Data Kurang Tepat !.')</script>";
            echo "<script type='text/javascript'>history.go(-1)</script>";
          }else{
      ...
      <div class="widget-box">
        ...
        <div class="widget-content">
          ...
          <form action="" method="post" class="form-horizontal">
            ...
            <div class="control-group">
              <label for="normal" class="control-label">Ayah</label>
              <div class="controls">
                <input type="text" name="i_ayah" value="<?php echo $dataedit['ayah'] ?>" class="span8">
                <!-- <span class="help-block blue span8">(999) 999-9999</span> --> </div>
            </div>

            <div class="control-group">
              <label for="normal" class="control-label">Ibu</label>
              <div class="controls">
                <input type="text" name="i_ibu" value="<?php echo $dataedit['ibu'] ?>" class="span8">
                <!-- <span class="help-block blue span8">(999) 999-9999</span> --> </div>
            </div>
            ...
            <tr class="gradeX">
              ...
              <td style="text-align: center;"><?php echo $Ket; ?></td>
                ...
                <?php if ($data['kode_dusun']==0) {?>
                  ...
                  <a href="#myModal" data-toggle="modal" class="btn btn-mini btn-warning">Edit</a>
                <?php }else{ ?>
                  <a href="?page=penduduk&&aksi=detail&&kode=<?php echo $data['nik'] ?>" class="btn btn-mini btn-info">Detail</a>
