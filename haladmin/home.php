...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="Beranda" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a></div>
  </div>
<!--End-breadcrumbs-->

<?php  
  $querypelayanan = $dbconnect->query("SELECT COUNT(*) AS jumlahpelayanan FROM tb_layanan");
  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_ly span3"> <a href="#"> <i class="icon-inbox"></i><span class="label label-success"><?php echo $hitungpelayanan['jumlahpelayanan']; ?></span> Pelayanan </a> </li>
